...
```{r}
# filter by words that appear more than 60 times and create bat chart 
emma_joy_nrc |>
...
# filter to words that appear over 60 times 
emma_joy_nrc_over_60 <- emma_joy_nrc |>
  count(word, sort =TRUE) |>
  filter(n > 60) 

# create a word cloud for the words that appear over 60 times 
wordcloud(words = emma_joy_nrc_over_60$word, 
       freq = emma_joy_nrc_over_60$n, 
       scale=c(3, 0.5),
       max.words = 20)
...
# filter to words that appear over 60 times 
emma_positive_affin_over_60 <- emma_positive_affin |>
  count(word, sort =TRUE) |>
  filter(n > 60) 

# create a word cloud for the words that appear over 60 times 
wordcloud(words = emma_positive_affin_over_60$word, 
       freq = emma_positive_affin_over_60$n, 
       max.words = 20)
```
